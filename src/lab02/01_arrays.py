...
for case_list in min_max_case_list: print(min_max(case_list))
print('-' * 20)
...
unique_sorted_case_list = [[3, 1, 2, 1, 3], [], [-1, -1, 0, 2, 2], [1.0, 1, 2.5, 2.5, 0]]
for case_list in unique_sorted_case_list: print(unique_sorted(case_list))
print('-' * 20)
...
flatten_case_list = [[[1, 2], [3, 4]], ([1, 2], (3, 4, 5)), [[1], [], [2, 3]], [[1, 2], "ab"]]
for case_list in flatten_case_list: print(flatten(case_list))
print('-' * 20)