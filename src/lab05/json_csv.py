...
def json_to_csv(json_path: str, csv_path: str, path_suffix=(".json", ".csv")) -> None:
    json_path, csv_path = pathProccesing(json_path, False, path_suffix), pathProccesing(
        csv_path, True, path_suffix
    )
    if json_path:
...
def csv_to_json(csv_path: str, json_path: str, path_suffix=(".json", ".csv")) -> None:
    csv_path, json_path = pathProccesing(csv_path, False, path_suffix), pathProccesing(
        json_path, True, path_suffix
    )
    if csv_path:
