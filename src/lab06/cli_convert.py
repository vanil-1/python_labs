...
def main():
    ...
    path_in, path_out = f'{main_path}samples/{args.input}', f'{main_path}out/{args.output}'

    if args.cmd == 'json2csv': json_to_csv(path_in, path_out)
    elif args.cmd == 'csv2json': csv_to_json(path_in, path_out)
    elif args.cmd == 'csv2xlsx': csv_to_xlsx(path_in, path_out)
